  ...
  return (
    <header className='w-full h-[72px] bg-red-500-2'>
      <div className='p-4 flex items-center flex-row justify-between bg-yellow-500-2'>
        <Input width={350} backgroundcolor={'F3F4F6'} placeholdertemplatestr='Search' icon={<SearchIcon />} />
        <ul className='flex justify-between items-center mr-4 gap-8'>
          <li><Button reststyle={'px-4 py-2 rounded-[6px] text-sm hover:scale-[1.05] transition-all'} bgcolor='115467' text={{ color: 'text-white', content: '+ Add Task' }} /></li>
